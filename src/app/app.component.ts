...
export class AppComponent implements OnInit {
    ...
    useFullCode() {
        // for(let y = 0; y < asciiImg.height; y++) {
        //   asciiCharArray[y] = [];
        //   for (let x = 0; x < asciiImg.width; x++) {
        //     // const index = (x + y * asciiImg.width) * 4;
        //     const actualImageX = Math.floor(x/asciiImg.width * img.width);
        //     const actualImageY = Math.floor(y/asciiImg.height * img.height);
        //     const actualImageIndex = (actualImageX + actualImageY * img.width) * 4;
        //     const [r, g, b] = [img.pixels[actualImageIndex], img.pixels[actualImageIndex + 1], img.pixels[actualImageIndex + 2]]
        //     let grayScaleAvg = (r + g + b) / 3
        //     grayScaleAvg = grayScaleAvg > 150 ? 255 : grayScaleAvg < 70 ? 0 : grayScaleAvg;
        //     grayScaleAvg = 255 - grayScaleAvg;
        //     const i = Math.floor((grayScaleAvg * (chars.length - 1))/255)
        //     const char = chars[i];
        //     asciiCharArray[y][x] = {char};
        //     // asciiImg.pixels[index] = grayScaleAvg
        //     // asciiImg.pixels[index + 1] = grayScaleAvg
        //     // asciiImg.pixels[index + 2] = grayScaleAvg
        //     // asciiImg.pixels[index + 3] = 255;
        //     // const colors = [[0, 59 ,0], [0, 143, 17], [0, 255, 40], [0, 255, 130]]
        //     // p5.fill(...colors[Math.floor(4 * Math.random())])
        //     // p5.fill(r, g, b)
        //     // p5.fill()
        //     // p5.textSize(canvasHeight / asciiImgHeight)
        //     // const aspectRatio = asciiImgHeight / asciiImgWidth;
        ...
        //         let prevColor = asciiCharArray[y - 1][x].color;
        //         let count = 1;
        //         while (asciiCharArray[y - i] && asciiCharArray[y - i][x].color === prevColor && count <= 10) {
        //           count++;
        //           prevColor = asciiCharArray[y - i][x].color;
        //           i++;
        //         }
        ...
        //     p5.textSize(canvasHeight / asciiImgHeight)
        //     const aspectRatio = asciiImgHeight / asciiImgWidth;
        //     const charY = canvasHeight / asciiImgHeight;
        //     const charX = (canvasHeight / aspectRatio) / asciiImgWidth;
        //     p5.fill('#00FF41')
        //     asciiCharArray[y][x].color = this.matrix ? color : '#00FF41';
        //     p5.text(asciiCharArray[y][x].char, x * charX, y * charY);
        //   }
        ...
        // img.updatePixels();
        // asciiImg.updatePixels();
        // p5.image(asciiImg, 0, 0)
    }
